...
export interface NodeTypeDef {
  ...
  configSchema?: import("@/lib/types/shared").ConfigField[];
  description: string;
}
...
export const NODE_TYPES: NodeTypeDef[] = [
  ...
  // chart artifact computed over the full data (see the backend chart nodes).
  {
    ...
    label: "Bar Chart",
    category: "chart",
    defaultConfig: { title: "", x: "", y: "", aggregate: "sum", group_by: "", orientation: "vertical", limit: null },
    inputHandles: ["in"],
    hasOutput: true,
    isFlowTerminal: true,
  ...
  },
  {
    ...
    label: "Line Chart",
    category: "chart",
    defaultConfig: { title: "", x: "", y_columns: [], aggregate: "mean" },
    inputHandles: ["in"],
    hasOutput: true,
    isFlowTerminal: true,
  ...
  },
  {
    ...
    label: "Pie Chart",
    category: "chart",
    defaultConfig: { title: "", category: "", value: "", aggregate: "count", limit: null },
    inputHandles: ["in"],
    hasOutput: true,
    isFlowTerminal: true,
  ...
  },
  {
    ...
    label: "Histogram",
    category: "chart",
    defaultConfig: { title: "", column: "", bins: 20 },
    inputHandles: ["in"],
    hasOutput: true,
    isFlowTerminal: true,
  ...
  },
  {
    ...
    label: "Box Plot",
    category: "chart",
    defaultConfig: { title: "", column: "", group_by: "" },
    inputHandles: ["in"],
    hasOutput: true,
    isFlowTerminal: true,

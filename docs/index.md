...
```bash
git clone https://github.com/rodrigo-arenas/Ciaren
cd Ciaren/backend
pip install -e .
ciaren serve
```
...
- ⭐ **[Star us on GitHub](https://github.com/rodrigo-arenas/Ciaren)** — it helps others discover the project
- 💬 **[Ask in Discussions](https://github.com/rodrigo-arenas/Ciaren/discussions)** — questions and ideas welcome
- 🐛 **[Report a bug](https://github.com/rodrigo-arenas/Ciaren/issues)** — or request a feature

...
- **Setting a `default` automatically enables it** — you only need `use_default: false`
  explicitly if you want unmapped values to pass through unchanged *despite* having
  set a `default`.

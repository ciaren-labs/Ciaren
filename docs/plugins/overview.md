...
[`examples/plugins/hello-node-plugin/`](https://github.com/rodrigo-arenas/FlowFrame/tree/main/examples/plugins/hello-node-plugin),
with a pre-built **signed** package in
[`examples/plugins/dist/`](https://github.com/rodrigo-arenas/FlowFrame/tree/main/examples/plugins/dist).
...
[Discussion](https://github.com/rodrigo-arenas/FlowFrame/discussions) to share it
with the community.

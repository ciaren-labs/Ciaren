...
[`examples/plugins/dist/`](https://github.com/rodrigo-arenas/Ciaren/tree/main/examples/plugins/dist).
...
[Discussion](https://github.com/rodrigo-arenas/Ciaren/discussions) to share it
with the community.
